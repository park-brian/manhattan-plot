import { defaultConfig, defaultStyles } from './defaults.js';
...
export class ManhattanPlot {
  ...
  draw() {
    ...
    fill(this.plotContext, this.styles.backgroundColor);
    fill(this.genePlotContext, this.styles.backgroundColor);
  ...
  initEvents() {
    ...
    if (behaviors.pan) {
      enablePan(plotOverlayContext, config);
    }
